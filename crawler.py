...
class HorseCrawler:
    ...
    def crawl_horse(self, horse_id: str) -> bool:
        print("-----------------------------")
...
if __name__ == "__main__":
    ...
    # test_crawler.crawl_horse("2019102383")

    f = open("crawl_list.txt", 'r')
    ...
    test_crawler = HorseCrawler()
    test_crawler.crawl_limit = 10000
